...
def test_pronunciation_is_cached(tmp_path, monkeypatch):
    ...
    first = client.post("/api/pronunciation", json=payload)
    second = client.post("/api/pronunciation", json=payload)
